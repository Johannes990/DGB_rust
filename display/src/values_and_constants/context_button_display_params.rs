...
pub struct ContextButtonDisplayParams {
    ...
    pub context_button_x_pad: f32,
    pub context_button_y_pad: f32,
...
impl ContextButtonDisplayParams {
    pub fn new() -> Self {
        ...
        let context_button_x_pad = 5.0;
        let context_button_y_pad = 5.0;
        ...
        let quit_yes_x = screen_width() / 2.0 - 100.0 - context_button_width;
        let quit_no_x = screen_width() / 2.0 + 100.0;
        let quit_yes_y = screen_height() * 0.5;
        let quit_no_y = screen_height() * 0.5;

        Self {
            context_button_width,
            context_button_height,
            context_button_x_pad,
            context_button_y_pad,
            context_back_x,
            context_back_y,
            context_quit_x,
            context_quit_y,
